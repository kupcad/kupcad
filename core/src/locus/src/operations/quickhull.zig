...
// (Kept completely isolated from the standard TopologyArena)
pub const HullHalfEdge = struct {
    end_vertex: u32,
...
pub const QuickhullBuilder = struct {
    ...
    half_edges: std.ArrayListUnmanaged(HullHalfEdge) = .empty,
    ...
    fn addFace(self: *QuickhullBuilder, v0: u32, v1: u32, v2: u32) !u32 {
        ...
        try self.half_edges.appendSlice(self.allocator, &[_]HullHalfEdge{
